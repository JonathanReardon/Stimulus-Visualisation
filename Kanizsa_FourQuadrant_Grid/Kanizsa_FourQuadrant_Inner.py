...
class Triangle2(object):
    def __init__(self):
        """create visual components of triangle"""
        self.triangle = visual.ShapeStim(win, units = 'deg', vertices = ((grid4),(grid6),(grid5)) , lineColor='white', fillColor='white')
...
class Triangle3(object):
    def __init__(self):
        """create visual components of triangle"""
        self.triangle = visual.ShapeStim(win, units = 'deg', vertices = ((grid7),(grid9),(grid8)) , lineColor='white', fillColor='white')
...
class Triangle4(object):
    def __init__(self):
        """create visual components of triangle"""
        self.triangle = visual.ShapeStim(win, units = 'deg', vertices = ((grid10),(grid12),(grid11)) , lineColor='white', fillColor='white')
