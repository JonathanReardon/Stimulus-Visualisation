...
while running == True:
    ...
    string="hi"
    mouse_fix_distance_label = visual.TextStim(win, text="Mouse to Fix Dist: ", pos=(9,-7), height=.75, color="red", colorSpace='rgb')
    mouse_fix_distance_pos = visual.TextStim(win, pos=(12,-7), height=.75, color="red", colorSpace='rgb')
